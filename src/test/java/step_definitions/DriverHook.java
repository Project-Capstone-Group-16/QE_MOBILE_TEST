...
//        setBrowserstackStatus(!scenario.isFailed());  //NI CODE DISAMPING DIILANGIN AMAN KALAU LOCAL,belum dicoba kalau pake browserstack. kalau code ini dinyalain di local bakalan error
        driver.quit();
        System.out.println("""
    ...
    void useLocalDriver() throws MalformedURLException {
        UiAutomator2Options options = new UiAutomator2Options()
                ...
                .setApp("D:/Kuliah/MSIB/CODINGAN/TEMPLATEMOVILETESTING/cucumber-appium-java/app-release.apk"); //location apps (APK) ON LOCAL STORAGE (BISA GANTI TAR KALAU DI DEVICE LAIN)
//                .setAppPackage("com.example.capstone") // change to package name of application to be tested
